...
with DAG(dag_id='pilot_dag', schedule_interval='0 0 * * *', default_args=default_args, catchup=False) as dag:
    ...
    task_5 = PythonOperator(task_id='task_5', python_callable=process_done, op_args=['my super parameter'])
